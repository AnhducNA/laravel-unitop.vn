        ...
        <div class="row">
            <div class="col-12">
                ...
                <form action="{{route('cart.update')}}" method="POST">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td scope="col">
                                    <input type="number" name="qty[{{$row->rowId}}]" value="{{$row->qty}}" min=1 style=" width:50px; text-align: center ">
                                </td>
                                <td scope=" col">{{number_format($row->total, 0, ',' , '.')}} đ
                                </td>
                    ...
                    <input type="submit" value="Cập nhật giỏ hàng" name="btn-update" class="btn btn-primary">
